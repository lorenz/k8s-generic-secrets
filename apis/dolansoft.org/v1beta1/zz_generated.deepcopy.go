...
func (in *CustomTokenSpec) DeepCopyInto(out *CustomTokenSpec) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomTokenSpec.
func (in *CustomTokenSpec) DeepCopy() *CustomTokenSpec {
	if in == nil {
		return nil
	}
	out := new(CustomTokenSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SecretClaimSpec) DeepCopyInto(out *SecretClaimSpec) {
	*out = *in
	...
	if in.CustomTokenFields != nil {
		in, out := &in.CustomTokenFields, &out.CustomTokenFields
		*out = make(map[string]CustomTokenSpec, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
